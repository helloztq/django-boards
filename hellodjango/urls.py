...
urlpatterns = [
    ...
    # re_path(r'^posts/(?P<username>[\w.@+-]+)/$', views.post, name='post'),
    ...
    re_path(r'^setting/password/$', auth_views.PasswordChangeView.as_view(template_name='password_change.html'),
            name='password_change'),

    re_path(r'^setting/password/done/$', auth_views.PasswordChangeDoneView.as_view(template_name='password_change_done.html'),
    ...
    re_path(r'^settings/account/$', views.UserUpdateView.as_view(), name='my_account'),
]
